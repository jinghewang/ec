    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 rb-md-6"><h4>GF-2014-2401</h4></div>
    </div>
    <div class="row title">
        <div class="text-center"><h2>{$version.title}<br />（示范文本）</h2></div>
    </div>
    <div class="row gbcompany">
        <div class="col-xs-5 col-sm-5 col-md-5 col-xs-offset-2 col-sm-offset-2 col-md-offset-2 "><h3>国家旅游局</h3></div>
        <div class="clear col-xs-5 col-sm-5 col-md-5 col-xs-offset-2 col-sm-offset-2 col-md-offset-2"><h3>国家工商行政管理总局</h3></div>
        <div class="col-xs-2 col-sm-2 col-md-2 col-xs-offset-1 col-sm-offset-1 col-md-offset-1"><h3>制定</h3></div>
        <div class="clear col-xs-5 col-sm-5 col-md-5 col-xs-offset-2 col-sm-offset-2 col-md-offset-2"><h3>二〇一四年四月</h3></div>
    </div>
    {$PAGE_BREAK}
    ...
    <div class="row desc">
        <ol>
            <li>本合同为示范文本，供中华人民共和国境内（不含港、澳、台地区）经营出境旅游业务或者边境旅游业务的旅行社（以下简称“出境社”）与出境旅游者（以下简称“旅游者”）之间签订团队出境包价旅游（不含赴台湾地区旅游）合同时使用。</li>
            <li>双方当事人应当结合具体情况选择本合同协议条款中所提供的选择项，空格处应当以文字形式填写完整。</li>
            <li>双方当事人可以书面形式对本示范文本内容进行变更或者补充，但变更或者补充的内容，不得减轻或者免除应当由出境社承担的责任。</li>
            <li>本示范文本由国家旅游局和国家工商行政管理总局共同制定、解释，在全国范围内推行使用。</li>
        </ol>
    </div>
    {$PAGE_BREAK}
    <div class="row">
        <div class="text-center"><h3>{$version.title}</h3></div>
        <div>
            <p>
                旅游者：<u>{$assigned.name}</u>等<u>{count($travellers)}</u>人（名单可附页，需出境社和旅游者代表签字盖章确认）；
            </p>
            <p>
                出境社：<u>{$provider.name}</u>
            </p>
            <p>
    ...
    <div class="row">
        ...
        <div>
            ...
            <ol>
                <li>团队出境旅游服务，指出境社依据《中华人民共和国旅游法》、《中国公民出国旅游管理办法》和《旅行社条例》等法律、法规，组织旅游者出国旅游及赴中外双方政府商定的国外边境区域和港、澳地区等旅游目的地旅游，代办旅游签证／签注，代订公共交通客票，提供餐饮、住宿、游览等两项以上服务活动。</li>
                <li>旅游费用，指旅游者支付给出境社，用于购买本合同约定的旅游服务的费用。</li>
                <p>旅游费用包括：</p>
                <ol class="list-none">
                    ...
                    <li>（3）住宿费；</li>
                    <li>（4）餐费（不含酒水费）；</li>
                    <li>（5）出境社统一安排的景区景点的门票费；</li>
                    <li>（6）行程中安排的其他项目费用；</li>
                    <li>（7）导游服务费； </li>
                    <li>（8）边境旅游中办理旅游证件的费用；</li>
                    <li>（9）出境社、境外地接社等其他服务费用。</li>
                </ol>
                <p>旅游费用不包括：</p>
                <ol class="list-none">
                    <li>（1）办理护照、港澳通行证的费用；</li>
                    <li>（2）办理离团的费用；</li>
                    <li>（3）旅游者投保的人身意外伤害保险费用；</li>
                    <li>（4）合同未约定由出境社支付的费用，包括但不限于行程以外非合同约定项目所需的费用、自行安排活动期间发生的费用; </li>
                    <li>（5）境外小费; </li>
                    <li>（6）行程中发生的旅游者个人费用，包括但不限于交通工具上的非免费餐饮费、行李超重费，住宿期间的洗衣、通讯 、饮料及酒类费用，个人娱乐费用，个人伤病医疗费，寻找个人遗失物品的费用及报酬，个人原因造成的赔偿费用。</li>
                </ol>
                ...
                <li>不合理的低价，指出境社提供服务的价格低于接待和服务费用或者低于行业公认的合理价格，且无正当理由和充分证据证明该价格的合理性。其中，接待和服务费用主要包括出境社提供或者采购餐饮、住宿、交通、游览、导游或者领队等服务所支出的费用。</li>
                ...
                <li>离团，指团队旅游者在境外经领队同意不随团队完成约定行程的行为。</li>
                <li>脱团，指团队旅游者在境外未经领队同意脱离旅游团队，不随团队完成约定行程的行为。</li>
                <li>转团，指由于未达到约定成团人数不能出团，出境社征得旅游者书面同意，在行程开始前将旅游者转至其他出境社所组的出境旅游团队履行合同的行为。</li>
                <li>拼团，指出境社在保证所承诺的服务内容和标准不变的前提下，在签订合同时经旅游者同意，与其他出境社招徕的旅游者拼成一个团统一安排旅游服务的行为。</li>
                ...
                <li>必要的费用，指出境社履行合同已经发生的费用以及向地接社或者履行辅助人支付且不可退还的费用, 包括乘坐飞机（车、船）等交通工具的费用（含预订金）、旅游签证/签注费用、饭店住宿费用（含预订金）、旅游观光汽车的人均车租等。</li>
    ...
    <div class="row">
        ...
        <div>
            ...
            <ol class="list-none">
                ...
                <li>（2）旅游目的地地接社的名称、地址、联系人和联系电话；</li>
                ...
                <li>（6）出境社统一安排的游览项目的具体内容及时间（明确旅游线路内容包括景区点及游览项目名称、景区点停留的最少时间）；</li>
                <li>（7）自由活动的时间；</li>
    ...
    <div class="row">
        ...
        <div>
            ...
            <ol>
                ...
                <li>要求旅游者对在旅游活动中或者在解决纠纷时损害出境社合法权益的行为承担赔偿责任；</li>
        ...
        <div>
            ...
            <ol>
                ...
                <li>不以不合理的低价组织旅游活动，诱骗旅游者，并通过安排购物或者另行付费旅游项目获取回扣等不正当利益；
                    组织、接待旅游者，不指定具体购物场所，不安排另行付费旅游项目，但是，经双方协商一致或者旅游者要求，且不影响其他旅游者行程安排的除外；
                </li>
                <li>在出团前采取行前说明会等方式，如实告知具体行程安排和有关具体事项。具体事项包括但不限于旅游目的地国家或者地区的相关法律、法规和风俗习惯、文化传统和宗教禁忌；旅游活动中的安全注意事项和安全避险措施、旅游者不适合参加旅游活动的情形；出境社依法可以减免责任的信息；境外小费标准、外汇兑换事项、应急联络方式（包括我驻外使领馆及出境社境内和境外应急联系人及联系方式）；法律、法规规定的其他应当告知的事项；</li>
                <li>为旅游团队安排符合《中华人民共和国旅游法》、《旅行社条例》、《中国公民出国旅游管理办法》等法律、法规规定的持证领队人员；</li>
                <li>妥善保管旅游者交其代管的证件、行李等物品；</li>
                <li>为旅游者发放用中英文固定格式书写、由旅游者填写的安全信息卡（内容包括旅游者的姓名、国籍、血型、应急联络方式等）；</li>
        ...
        <div>
            <p>第七条&emsp;旅游者的权利</p>
            <ol>
                <li>要求出境社按照合同及《行程单》约定履行相关义务；</li>
                <li>拒绝出境社未经事先协商一致的转团、拼团行为；</li>
                <li>有权自主选择旅游产品和服务，有权拒绝出境社未与旅游者协商一致或者未经旅游者要求而指定购物场所、安排旅游者参加另行付费旅游项目的行为，有权拒绝出境社的导游、领队强迫或者变相强迫旅游者购物、参加另行付费旅游项目的行为； </li>
                <li>在支付旅游费用时要求出境社出具发票； </li>
                <li>人格尊严、民族风俗习惯和宗教信仰得到尊重；</li>
                <li>在人身、财产安全遇有危险时，有权请求救助和保护；人身、财产受到侵害的，有权依法获得赔偿；</li>
                <li>在合法权益受到损害时向有关部门投诉或者要求出境社协助索赔；</li>
        ...
        <div>
            <p>第八条&emsp;旅游者的义务</p>
            <ol>
                <li>如实填写《出境旅游报名表》、签证/签注资料和游客安全信息卡等各项内容，告知与旅游活动相关的个人健康信息，并对其真实性负责，保证所提供的联系方式准确无误且能及时联系； </li>
                <li>向出境社提交能有效使用的因私护照或者通行证，自办签证/签注者应当确保所持签证/签注在出游期间有效；</li>
                <li>按照合同约定支付旅游费用；</li>
                <li>按照合同约定随团完成旅游行程，配合领队人员的统一管理；</li>
                <li>遵守我国和旅游目的地国家（地区）的法律、法规和有关规定，不携带违禁物品出入境；不参与色情、赌博和涉毒活动；不擅自脱团；不在境外滞留不归；</li>
                <li>遵守旅游目的地国家（地区）的公共秩序和社会公德，尊重当地的风俗习惯，文化传统和宗教信仰，爱护旅游资源，保护生态环境，遵守《中国公民出国（境）旅游文明行为指南》等文明行为规范；</li>
    ...
    <div class="row">
        ...
        <div>
            <p>第九条&emsp;合同的变更</p>
            <ol>
                <li>出境社与旅游者双方协商一致，可以变更本合同约定的内容，但应当以书面形式由双方签字确认。由此增加的旅游费用及给对方造成的损失，由变更提出方承担；由此减少的旅游费用，出境社应当退还旅游者。</li>
                <li>行程开始前遇到不可抗力或者出境社、履行辅助人已尽合理注意义务仍不能避免的事件的，双方经协商可以取消行程或者延期出行。取消行程的，按照本合同第十四条处理；延期出行的，增加的费用由旅游者承担，减少的费用退还旅游者。</li>
                <li>行程中遇到不可抗力或者出境社、履行辅助人已尽合理注意义务仍不能避免的事件，影响旅游行程的，按以下方式处理：</li>
                <ol class="list-none">
                    <li>（1）合同不能完全履行的，旅行社经向旅游者作出说明，旅游者同意变更的，可以在合理范围内变更合同，因此增加的费用由旅游者承担，减少的费用退还旅游者。</li>
                    <li>（2）危及旅游者人身、财产安全的，旅行社应当采取相应的安全措施，因此支出的费用，由出境社与旅游者分担。</li>
        ...
        <div>
            ...
            <ol>
                <li>转团：出境社可以在保证所承诺的服务内容和标准不降低的前提下，经事先征得旅游者书面同意，委托其他旅行社履行合同，并就受委托出团的出境社违反本合同约定的行为先行承担责任，再行追偿。旅游者和受委托出团的出境社另行签订合同的，本合同的权利义务终止。</li>
                <li>延期出团或者改签线路出团：出境社经征得旅游者书面同意，可以延期出团或者改签其他线路出团，因此增加的费用由旅游者承担，减少的费用出境社予以退还。需要时可以重新签订旅游合同。</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div>
            <p>第十二条&emsp;出境社解除合同</p>
            <ol>
                <li>未达到约定的成团人数不能成团时，出境社解除合同的，应当采取书面等有效形式。出境社在行程开始前30日（按照出发日减去解除合同通知到达日的自然日之差计算，下同）以上（含第30日，下同）提出解除合同的，不承担违约责任，出境社向旅游者退还已收取的全部旅游费用（不得扣除签证/签注费用）；出境社在行程开始前30日以内（不含第30日，下同）提出解除合同的，除向旅游者退还已收取的全部旅游费用外，还应当按照本合同第十七条第1款的约定承担相应的违约责任。</li>
                <li>旅游者有下列情形之一的，出境社可以解除合同（相关法律、行政法规另有规定的除外）：</li>
                <ol class="list-none">
        ...
        <div>
            ...
            <ol>
                <li>未达到约定的成团人数不能成团时，旅游者既不同意转团，也不同意延期出行或者改签其他线路出团的，出境社应及时发出不能成团的书面通知，旅游者可以解除合同。旅游者在行程开始前30日以上收到旅行社不能成团通知的，旅行社不承担违约责任，向旅游者退还已收取的全部旅游费用；旅游者在行程开始前30日以内收到旅行社不能成团通知的，按照本合同第十七条第1款相关约定处理。</li>
                <li>除本条第1款约定外，在行程结束前，旅游者亦可以书面等形式解除合同（相关法律、行政法规另有规定的除外）。旅游者在行程开始前30日以上提出解除合同的，未办理签证/签注的，出境社应当向旅游者退还全部旅游费用；已办理签证/签注的，应当扣除签证/签注费用（旅游者自办的除外）；旅游者在行程开始前30日以内提出解除合同的，出境社按照本合同第十五条相关约定扣除必要的费用后，将余款退还旅游者。</li>
        ...
        <div>
            ...
            <ol>
                <li>旅游者在行程开始前30日以内提出解除合同或者按照本合同第十二条第2款约定由出境社在行程开始前解除合同的，按下列标准扣除必要的费用：</li>
    ...
    <div class="row">
        ...
        <div>
            <p>第十七条&emsp;出境社的违约责任</p>
            <ol>
                <li>出境社在行程开始前30日以内提出解除合同的，或者旅游者在行程开始前30日以内收到出境社不能成团通知，不同意转团、延期出行和改签线路解除合同的，出境社向旅游者退还已收取的全部旅游费用（不得扣除签证／签注等费用），并按下列标准向旅游者支付违约金： </li>
                ...
                <li>出境社未按合同约定提供服务，或者未经旅游者同意调整旅游行程（本合同第九条第3款规定的情形除外），造成项目减少、旅游时间缩短或者标准降低的，应当依法承担继续履行、采取补救措施或者赔偿损失等违约责任。</li>
                <li>出境社具备履行条件，经旅游者要求仍拒绝履行本合同义务的，出境社向旅游者支付旅游费用总额30%的违约金，旅游者采取订同等级别的住宿、用餐、交通等补救措施的，费用由出境社承担；造成旅游者人身损害、滞留等严重后果的，旅游者还可以要求出境社支付旅游费用一倍以上三倍以下的赔偿金。</li>
                <li>未经旅游者同意，出境社转团、拼团的，出境社应向旅游者支付旅游费用总额25%的违约金；旅游者解除合同的，出境社还应向未随团出行的旅游者退还全部旅游费用，向已随团出行的旅游者退还尚未发生的旅游费用。如违约金不足以赔偿旅游者的实际损失，出境社应当按实际损失对旅游者予以赔偿。</li>
                <li>出境社有以下情形之一的，旅游者有权在旅游行程结束后30日内，要求出境社为其办理退货并先行垫付退货货款，或者退还另行付费旅游项目的费用：</li>
                <ol class="list-none">
                    <li>（1）出境社以不合理的低价组织旅游活动，诱骗旅游者，并通过安排购物或者另行付费旅游项目获取回扣等不正当利益的；</li>
                    <li>（2）未经双方协商一致或者未经旅游者要求，出境社指定具体购物场所或者安排另行付费旅游项目的。</li>
                </ol>
                <li>与旅游者出现纠纷时，出境社应当积极采取措施防止损失扩大，否则应当就扩大的损失承担责任。</li>
            </ol>
        </div>
        <div>
            <p>第十八条&emsp;旅游者的违约责任</p>
            <ol>
                <li>因不听从出境社及其领队的劝告、提示而影响团队行程，给出境社造成损失的，应当承担相应的赔偿责任。</li>
                <li>旅游者超出本合同约定的内容进行个人活动所造成的损失，由其自行承担。</li>
                <li>由于旅游者的过错，使出境社、履行辅助人、旅游从业人员或者其他旅游者遭受损害的，应当由旅游者赔偿损失。</li>
        ...
        <div>
            <p>第十九条&emsp;其他责任</p>
            <ol>
                <li>因旅游者提供材料存在问题或者自身其他原因被拒签、缓签、拒绝入境和出境的，相关责任和费用由旅游者承担，出境社将未发生的费用退还旅游者。如给出境社造成损失的，旅游者还应当承担赔偿责任。因出境社原因导致旅游者被拒签而解除合同的，依据本合同第十七条第1款处理。</li>
                <li>由于旅游者自身原因导致本合同不能履行或者不能按照约定履行，或者造成旅游者人身损害、财产损失的，出境社不承担责任。</li>
                <li>旅游者自行安排活动期间人身、财产权益受到损害的，出境社在事前已尽到必要警示说明义务且事后已尽到必要救助义务的，出境社不承担赔偿责任。</li>
                <li>由于第三方侵害等不可归责于出境社的原因导致旅游者人身、财产权益受到损害的，出境社不承担赔偿责任。但因出境社不履行协助义务致使旅游者人身、财产权益损失扩大的，应当就扩大的损失承担赔偿责任。</li>
                <li>由于公共交通经营者的原因造成旅游者人身损害、财产损失依法应承担责任的，出境社应当协助旅游者向公共交通经营者索赔。</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div>
            ...
            <p>成人<u>&emsp;{$pay.numAdult}&emsp;</u>人、成人<u>&emsp;{$pay.payEachAdult}&emsp;</u>元/人、儿童（不满12岁）<u>&emsp;{$pay.numChild}&emsp;</u>人、儿童<u>&emsp;{$pay.payEachChild}&emsp;</u>元/人；其中，导游服务费<u>&emsp;{$group.payGuide}&emsp;</u>元/人；</p>
        ...
        <div>
            ...
            <ol>
                <li>出境社提示旅游者购买人身意外伤害保险；</li>
                <li>旅游者可以做以下选择：</li>
                <ol class="list-unstyled">
                    <li>{hlt_checkbox value=$insurance.purchases}委托出境社购买 （出境社不具有保险兼业代理资格的，不得勾选此项）：</li>
        ...
        <div class="">
            ...
            <ol class="list-unstyled">
                ...
                <ol>
                    <li><u>&emsp;{hlt_result value=$otherGroup.transAgree}&emsp;</u>（同意或者不同意，打勾无效）出境社委托<u>&emsp;{$otherGroup.transAgency}&emsp;</u>出境社履行合同；</li>
        ...
        <div>
            ...
            <ol>
                <li>旅游者可以自主决定是否参加出境社安排的购物活动、另行付费旅游项目；</li>
                <li>出境社可以在不以不合理的低价组织旅游活动、不诱骗旅游者、不获取回扣等不正当利益，且不影响其他旅游者行程安排的前提下，按照平等自愿、诚实信用的原则，与旅游者协商一致达成购物活动、另行付费旅游项目协议；</li>
                <li>购物活动、另行付费旅游项目安排应不与《行程单》冲突；</li>
                <li>地接社及其从业人员在行程中安排购物活动、另行付费旅游项目的，责任由订立本合同的出境社承担；</li>
                <li>购物活动、另行付费旅游项目具体约定见《自愿购物活动补充协议》（附件3）、《自愿参加另行付费旅游项目补充协议》（附件4）。</li>
            </ol>
        </div>
        {$PAGE_BREAK}
        <div class="">
            <p>第二十六条&emsp;争议的解决方式</p>
            <p>本合同履行过程中发生争议，由双方协商解决；亦可向合同签订地的旅游质监执法机构、消费者协会、有关的调解组织等有关部门或者机构申请调解。协商或者调解不成的，按下列第<u>&emsp;2&emsp;</u>种方式解决：</p>
            <ol>
                <li>提交<u>&emsp;&emsp;&emsp;&emsp;</u>仲裁委员会仲裁；</li>
                <li>依法向人民法院起诉。</li>
            </ol>
        </div>
        <div>
        ...
        <div class="rb-org-info">
            <p>第二十八条&emsp;合同效力</p>
            <p>本合同一式贰份，双方各持壹份，具有同等法律效力，自双方当事人签字或者盖章之日起生效。</p>
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col rb-md-6">
                    旅游者（或代表）签字（盖章）：{$assigned.name} {$contractSign.signDataImage}
                </div>                <div class="col-xs-6 col-sm-6 col-md-6 col rb-md-6">
                    出境社盖章：{$provider.name}{$provider.sealDataImage}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col rb-md-6">
        ...
        <div class="">
            <p class="file">附件1：</p>
            <div class="text-center font-heiti"><h3>出境旅游报名表</h3></div>
            <p>旅游线路及编号：<u>&emsp;{$group.linename}({$group.teamcode})&emsp;</u>　　　旅游者出团时间意向:<u>&emsp;{$group.bgndate}&emsp;</u></p>
            <div class="">
                <table class="table table-bordered rb-table-bordered">
                    <tr>
                        <td class="text-center rb-th" width="12%">序号</td>
                        <td class="text-center rb-th" width="12%">姓名</td>
                    ...
                    {foreach from=$travellers key=num item="member"}
                        <tr>
                            ...
                            <td class="text-center rb-td">{$member.name}</td>
        ...
        <div class="">
            <p class="file">附件2：</p>
            <div class="text-center font-heiti"><h3>旅游行程单</h3></div>
            <div class="">
            ...
            <div class="">
                ...
                <div class="">
                    <table class="table table-bordered rb-table-bordered">
                        <tr class="">
                            ...
                            <td class="text-center rb-th" width="12%">停留时间（分钟）</td>
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        经办人签名：{$contract.transactor}
                    </div>
                </div>
            </div>
            {$PAGE_BREAK}
        {/if}
        {if $chargeables|@count neq 0 }
            {*自愿参加另行付费旅游项目补充协议*}
            <div class="">
                <p class="file">附件4：</p>
