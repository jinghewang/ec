    ...
    <div class="row desc">
        <ol>
            <li>本合同为示范文本，供中华人民共和国境内（不含港、澳、台地区）经营出境旅游业务或者边境旅游业务的旅行社（以下简称“出境社”）与出境旅游者（以下简称“旅游者”）之间签订出境包价旅游（不含赴台湾地区旅游）合同时使用。</li>
    ...
    <div class="row">
        ...
        <div>
            ...
            <ol>
                <li>出境旅游服务，指出境社依据《中华人民共和国旅游法》、《中国公民出国旅游管理办法》和《旅行社条例》等法律、法规，组织旅游者出国旅游及赴中外双方政府商定的国外边境区域和港、澳地区等旅游目的地旅游，代办旅游签证／签注，代订公共交通客票，提供餐饮、住宿、游览等两项以上服务活动。</li>
        ...
        <div>
            ...
            <ol>
                ...
                <li>不以不合理的低价组织旅游活动，诱骗旅游者，并通过安排购物或者另行付费旅游项目获取回扣等不正当利益；
                    组织、接待旅游者，不指定具体购物场所，不安排另行付费旅游项目，但是，经双方协商一致或者旅游者要求，且不影响其他旅游者行程安排的除外；</li>
    ...
    <div class="row">
        ...
        <div>
            ...
            <ol>
                ...
                <ol class="list-unstyled">
                    <li>{hlt_checkbox value=$insurance.purchases}委托旅行社购买 （出境社不具有保险兼业代理资格的，不得勾选此项）：</li>
        ...
        <div class="">
            ...
            <ol class="list-unstyled">
                ...
                <ol>
                    <li><u>&emsp;{hlt_result value=$otherGroup.transAgree}&emsp;</u>（同意或者不同意，打勾无效）出境社委托委托<u>&emsp;{$otherGroup.transAgency}</u>出境社履行合同；</li>
        ...
        <div class="rb-org-info">
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col rb-md-6">
                    ...
                    旅行社盖章：{$provider.name}{$provider.sealDataImage}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col rb-md-6">
        ...
        <div class="">
            ...
            <p>旅游线路及编号：<u>&emsp;{$group.linename}({$group.teamcode})&emsp;</u>　　　出团时间:<u>&emsp;{$group.bgndate}&emsp;</u></p>
            <div class="">
                <table class="table table-bordered rb-table-bordered">
                    <tr>
                        ...
                        <td class="text-center rb-th" width="12%">证件号码</td>
